...
int *pola_gdzie_damka_moze_sie_ruszyc; // wsk do tablicy
...
bool system_turowy = false; // "true" włącza gre turową
bool czyja_tura = true;     // "true" - ruch białych, "false" - ruch czarnych
bool wybrano_poprawnie_pionka_tury = false;

int kto_gra = 0; // "1" - gracz na gracza, "2"- gracz na komputer, "3" - komputer na komputer.  Może kiedyś się przyda xd
...
int main()
{
    ...
    while (wybor != "exit" && wybor != "0")
    {
        ...
        cout << "rozpoczyna gre turowa -- 5 (jeszcze nie ma)\n";
        //
        //
        ...
        {
            system_turowy = true; // "true" włącza gre turową, może się przyda
