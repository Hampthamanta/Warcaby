...
//ZMIANY!!!
//sprawdza jaki kolor jest na +11 polu - zbijanie w prawogóra
string sprawdz_kolor_pionka_na_plus11(int nr_pola)
{
    string kolor;
    for (int k = 0; k<24;k++)
    {
        if (nr_pola+11 == pionek[k].pole)
        {
...
//sprawdza jaki kolor jest na +9 polu - zbijanie lewogóra
string sprawdz_kolor_pionka_na_plus9(int nr_pola)
{
    string kolor;

    for (int k = 0; k<24;k++)
    {
        if (nr_pola+9 == pionek[k].pole)
        {
            kolor = pionek[k].kolor;
        }
    }
...
//sprawdza jaki kolor jest na -11 polu - zbijanie lewodół
string sprawdz_kolor_pionka_na_minus11(int nr_pola)
{
    string kolor;
...
//sprawdza jaki kolor jest na -9 polu - zbijanie prawodół
string sprawdz_kolor_pionka_na_minus9(int nr_pola)
{
    string kolor;
    for (int k = 0; k<24;k++)
    {
        ...
        if ((pole_pionka + 11) == pionek[i].pole)
         {
            ...
            if (sprawdz_kolor_pionka_na_plus11(pole_pionka)=="bialy")
            {
                zbijanie_prawo_gora = false;
            }
         }
        ...
        if ((pole_pionka + 9) == pionek[i].pole)
         {
            ...
            if (sprawdz_kolor_pionka_na_plus9(pole_pionka)=="bialy")
            {
                zbijanie_lewo_gora = false;
            }
         }
        ...
        if ((pole_pionka - 11) == pionek[i].pole)
         {
            ...
            if (sprawdz_kolor_pionka_na_minus11(pole_pionka)=="bialy")
            {
                zbijanie_lewo_dol = false;
            }
         }
        ...
        if ((pole_pionka - 9) == pionek[i].pole)
         {
           ...
           if (sprawdz_kolor_pionka_na_minus9(pole_pionka)=="bialy")
           {
               zbijanie_prawo_dol = false;
           }
         }
